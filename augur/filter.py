...
def register_arguments(parser):
    ...
    input_group.add_argument('--metadata-chunk-size', type=int, default=100000, help="maximum number of metadata records to read into memory at a time. Increasing this number can speed up data loading at the cost of more memory used.")
    ...
    input_group.add_argument('--cpus', type=int, default=1, help="Number of CPUs/cores/threads/jobs to utilize at once for data loading.")
