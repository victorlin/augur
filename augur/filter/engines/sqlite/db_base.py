...
from augur.io.metadata import get_metadata_id_column
...
from .subsample import get_valid_group_by_cols
...
class FilterDbBase(abc.ABC):
    def __init__(self, args:argparse.Namespace):
        self.args = args

    def try_run(self):
        """Try running filter. If there is an error, cleanup database artifacts and exit."""
        try:
            self.run()
