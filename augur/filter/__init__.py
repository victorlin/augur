...
def register_arguments(parser):
    ...
    input_group.add_argument('--metadata-chunk-size', type=int, default=100000, help="(pandas engine only) maximum number of metadata records to read into memory at a time. Increasing this number can speed up filtering at the cost of more memory used.")
