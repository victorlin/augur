...
from test_filter import parse_args, write_file, write_metadata
...
class TestDataLoading:
    def test_load_metadata(self, tmpdir, filter_obj:FilterSQLite):
    ...
    def test_load_priority_scores_valid(self, tmpdir, filter_obj:FilterSQLite):
        ...
        args = parse_args(f'--metadata "" --priority {priorities_fn}')
        filter_obj.set_args(args)
    ...
    def test_load_priority_scores_malformed(self, tmpdir, filter_obj:FilterSQLite):
    ...
    def test_load_priority_scores_valid_with_spaces_and_tabs(self, tmpdir, filter_obj:FilterSQLite):
    ...
    def test_load_priority_scores_does_not_exist(self, tmpdir, filter_obj:FilterSQLite):
        ...
        args = parse_args(f'--metadata "" --priority {invalid_priorities_fn}')
        filter_obj.set_args(args)
